const { makeCosmoshubPath, makeSignDoc } = require("@cosmjs-evm/amino");
const { pathToString } = require("@cosmjs-evm/crypto");
const { toBase64 } = require("@cosmjs-evm/encoding");
// eslint-disable-next-line @typescript-eslint/naming-convention
const { LedgerSigner } = require("@cosmjs-evm/ledger-amino");
// eslint-disable-next-line @typescript-eslint/naming-convention
