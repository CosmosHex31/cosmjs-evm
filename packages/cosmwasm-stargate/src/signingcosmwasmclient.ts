...
import { encodeSecp256k1Pubkey, makeSignDoc as makeSignDocAmino } from "@cosmjs-evm/amino";
import { sha256 } from "@cosmjs-evm/crypto";
import { fromBase64, toHex, toUtf8 } from "@cosmjs-evm/encoding";
import { Int53, Uint53 } from "@cosmjs-evm/math";
import {
  EncodeObject,
  encodePubkey,
...
import { CometClient, connectComet, HttpEndpoint } from "@cosmjs-evm/tendermint-rpc";
import { assert, assertDefined } from "@cosmjs-evm/utils";
...
import {pathToString} from  "@cosmjs-evm/crypto"
...
if (signerAny.accounts && signerAny.accounts[0] && signerAny.accounts[0].hdPath) {
