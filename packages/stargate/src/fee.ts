import { StdFee } from "@cosmjs-evm/amino";
import { Decimal, Uint53 } from "@cosmjs-evm/math";
import { coins } from "@cosmjs-evm/proto-signing";
...
export class GasPrice {
   ...
   * See `GasPrice` in @cosmjs-evm/stargate for a more generic matcher.
   *
