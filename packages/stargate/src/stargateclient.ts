...
import { addCoins } from "@cosmjs-evm/amino";
import { toHex } from "@cosmjs-evm/encoding";
import { Uint53 } from "@cosmjs-evm/math";
import { CometClient, connectComet, HttpEndpoint, toRfc3339WithNanoseconds } from "@cosmjs-evm/tendermint-rpc";
import { assert, sleep } from "@cosmjs-evm/utils";
...
export interface IndexedTx {
   ...
   * ```
   *
   * Use `decodeTxRaw` from @cosmjs-evm/proto-signing to decode this.
   */
